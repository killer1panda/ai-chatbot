...
import BookingWorkflow from '@/components/appointment/booking-workflow'
  ...
  if (!session?.user?.id)
    return (
      <div className="w-full flex justify-center">
        <p>Unable to load your appointment session. Please refresh.</p>
      </div>
    )
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 h-0 gap-5">
        ...
        <div className="col-span-1">
          ...
          <BookingWorkflow
            ...
            bookings={domainBookings?.bookings?.map((booking) => ({
              date: booking.date,
              slot: booking.slot,
