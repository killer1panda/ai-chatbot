    ...
    <main>
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4 ">
          ...
          <Link
            href="/auth/sign-up"
            className="bg-orange font-bold text-white px-4 py-2 rounded-md hover:bg-orange/80 transition-colors duration-200"
          >
            Start For Free
          </Link>
          <Image
          ...
          >
            ...
            <CardFooter className="flex flex-col items-start gap-4">
              ...
              <Link
                ...
                className="bg-[#f3d299] border-orange border-2 p-2 w-full text-center font-bold rounded-md hover:bg-orange hover:text-white transition-all duration-200"
              >
                Get Started
              </Link>
            </CardFooter>
